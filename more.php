...
<div class="section-header" style="padding-top:20px"><h2><?= t('management') ?></h2></div>
<div class="list-card">
  ...
  <a href="/users.php" class="list-item">
    ...
    <div class="item-body"><div class="item-title"><?= t('users') ?></div><div class="item-sub"><?= t('manage_users_sub') ?></div></div>
  ...
  <a href="/settings.php" class="list-item">
    ...
    <div class="item-body"><div class="item-title"><?= t('settings') ?></div><div class="item-sub"><?= t('app_preferences') ?></div></div>
    <svg class="chevron" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>
  </a>
...
<div class="section-header" style="padding-top:8px"><h2><?= t('data_section') ?></h2></div>
<div class="list-card">
  <a href="/activity.php" class="list-item">
    ...
    <div class="item-body"><div class="item-title"><?= t('recent_activity') ?></div><div class="item-sub"><?= t('activity_history') ?></div></div>
    <svg class="chevron" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>
  </a>
  ...
  <a href="/sync.php" class="list-item" id="sync-menu-item">
    ...
    <div class="item-body"><div class="item-title"><?= t('sync') ?></div><div class="item-sub" id="sync-sub"><?= t('check_sync') ?></div></div>
    <svg class="chevron" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>
  </a>
  ...
  <a href="/backup.php" class="list-item">
    ...
    <div class="item-body"><div class="item-title"><?= t('backup') ?></div><div class="item-sub"><?= t('export_import') ?></div></div>
    <svg class="chevron" viewBox="0 0 24 24"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>
  </a>
  <?php endif; ?>
</div>
